 ...
 */
class getHistorySearchRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\HistorySearchRepository' shared autowired service.
     *
     * @return \App\Repository\HistorySearchRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'HistorySearchRepository.php';

        return $container->privates['App\\Repository\\HistorySearchRepository'] = new \App\Repository\HistorySearchRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
